...
float determinant(const Vector& col1, const Vector& col2, const Vector& col3)
{
    // Calculate the determinant using the expansion by minors formula
    float det = col1.x * (col2.y * col3.z - col2.z * col3.y)
...
bool Triangle::intercepts(Ray& r, float& t ) {
	...
	t = determinant(this->points[1] - this->points[0], this->points[3] - this->points[0], r.origin - this->points[0]) /
		determinant(this->points[1] - this->points[0], this->points[3] - this->points[0], r.direction*(-1));
